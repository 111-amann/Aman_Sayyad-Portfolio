  ...
  return (
    ...
    >
      ...
      <div className="text-center z-10 px-4">
        ...
        <p className="text-grey-400 text-lg mb-8 max-w-lg mx-auto">I'm a frontend developer and aspiring full-stack developer who loves crafting clean, scalable web applications. Currently pursuing an MCA to deepen my understanding of computer science, I aim to build solutions that offer both exceptional performance and delightful user experiences.</p>
