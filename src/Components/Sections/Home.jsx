  ...
  return (
    ...
    >
      ...
      <div className="text-center z-10 px-4">
        ...
        <p className="text-grey-400 text-lg mb-8 max-w-lg mx-auto">I'm a Forntend developer, aspiring full-stack developer who loves crafting clean, scalable web applications. My goal is to build solutions that offer both exceptional performance and delightful user experience.</p>
